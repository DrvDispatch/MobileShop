...
/**
 * Base Skin - Support Page
 * 
 * Purely presentational. Receives data via props from SupportPageVM.
 */
...
export function SupportPage({ vm }: { vm: SupportPageVM }) {
    const { shopPhone, shopEmail, formattedAddress, openingHours, formatHoursForCard } = vm;
            ...
            <div className="mt-16 bg-zinc-900 rounded-2xl p-8 text-center text-white">
                ...
                <div className="space-y-2 max-w-md mx-auto text-sm">
                    {openingHours ? (
                        ...
                        <p className="opacity-60">Contact us for hours</p>
                    )}
                </div>
            </div>
        </div>
